...
if __name__ == '__main__':
    ...
    X = sorted(glob(det_path + '/*Hoe.tif'))

    nImages = len(X)
    if nImages > 1:
        print('more than Hoe.tif image in directory')
        exit()
    if nImages == 0:
        print('no file ending with Hoe.tif found')
        exit()
    ...
    model = StarDist2D(None, name='stardist400epochs', basedir='models')
